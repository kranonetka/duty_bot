...
class Bot:
    ...
    def _build_help_msg(self):  # type: () -> str
        msg = '❓ Команды:\n' \
              ...
              '🔸 Кто дежурит (кто дежурит сегодня) -- вывод дежурящих сегодня комнат\n' \
              '\n' \
              ...
              'Комнаты могут быть заданы как по одиночке, так и диапазоном\n' \
              'например: "+601 603-606"  -  добавит комнаты: 601, 603, 604, 605, 606\n' \
              '🔹 + <упоминание одного или более людей> -- добавить администраторов\n' \
              'например, "+ @id227725150 @id1"\n' \
              '🔹 - <упоминание одного или более людей> -- убрать администраторов\n' \
              '\n' \
              '🌟 Администраторы:\n'
